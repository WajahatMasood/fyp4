  ...
  return (
        <Fragment>
          ...
          <div className="banner">
            ...
            <Link  to="container" spy={true} smooth={true} offset={-100} duration={500} >
              <button>
                Scroll <CgMouse />
              </button>
            </Link> 
        ...
        <div class="card">
            ...
            <div class="card-text">
            Drinking milk prevent osteoporosis and bone fractures and even help you maintain a healthy weight.
            </div>
            <a  href="/PorductBenift" className="readmore"><KeyboardDoubleArrowDownIcon /></a>
        </div>
        <div class="card" id="card1">
            <div class="card-image"></div>
            <div class="card-title">Cheese </div>
            <div class="card-text">
            Cheese is a good source of calcium, a key nutrient for healthy bones and teeth, blood clotting.     
            </div>
             <a href="/PorductBenift" className="readmore"><KeyboardDoubleArrowDownIcon /></a>
        </div>
        ...
        <div class="card" id="card2">
            ...
            <div class="card-text">
            It's rich in nutrients like calcium and contains compounds linked to lower chances of obesity.            </div>
             <a href="/PorductBenift" className="readmore"><KeyboardDoubleArrowDownIcon /></a>
        </div>
        <div class="card" id="card3">
            ...
            <div class="card-text">
            Yogurts can be high in protein, calcium, vitamins, probiotics, which can enhance the gut microbiota            </div>
             <a href="/PorductBenift" className="readmore"><KeyboardDoubleArrowDownIcon /></a>
        </div>
    </div>
...
<div class="our-clients">
  <ul>
    <li> <img src="images/2.png" alt="" /> <img src="images/1-1.png" alt="" /> </li>
